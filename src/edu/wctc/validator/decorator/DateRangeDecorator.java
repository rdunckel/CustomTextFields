 ...
 * @author jlombardo
 */
public class DateRangeDecorator extends ValidatedJTextFieldDecorator {
	 ...
	 * @param startRange
	 *            - the start of the date range, inclusive. Must be formatted in
	 *            the short style of java.text.DateFormat.
	 * @param endRange
	 *            - the end of the date range, inclusive. Must be formatted in
	 *            the short style of java.text.DateFormat.
	 */
	public DateRangeDecorator(ValidatedJTextField textComponent,
		...
		errorMsg = "The field " + textComponent.getName()
				+ " requires a date between " + startRange + " and " + endRange
				+ " inclusive.";
	}
